...
public class GatewayAdminRequestController {
    ...
    public StatementDto getById(@PathVariable String statementId){
        ...
        StatementDto dto = gatewayService.getById(statementId);
    ...
    public List<StatementDto> getAllStatements(){
        ...
        List<StatementDto> statementList = gatewayService.getAllStatements();
