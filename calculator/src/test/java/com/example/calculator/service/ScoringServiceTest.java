...
import com.example.calculator.model.DTO.EmploymentDto;
...
class ScoringServiceTest {
    ...
    @Test
    void shouldReturnTrueForPrescoringWithAdultAge() {
        // Действие
        boolean actualValue = scoringService.preScoring(validRequestForOffers);
    ...
    @Test
    void shouldReturnFalseForPrescoringWithNoAdultAge() {
        // Подготовка
        validRequestForOffers.setBirthdate(LocalDate.of(2020, 1, 1));
